...
urlpatterns = [
    ...
    path('sales/outward_products/period/', outward_products.outward_product_summary_period,
         name='outward_product_period'),
    path('sales/outward_products/<str:date_0>/<str:date_1>/', outward_products.outward_product_summary_report,
