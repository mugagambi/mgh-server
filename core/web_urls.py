...
urlpatterns = [
    ...
    path('centers/<int:center>/availability/', web_views.product_availability_list, name='product-availability-list'),
    path('centers/availability/<int:pk>/update/', web_views.update_available_product,
         name='update-product-availability'),
    path('centers/<int:center>/availability/add/<str:day>/', web_views.product_availability,
         name='add-product-availability'),
